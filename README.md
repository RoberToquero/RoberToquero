...
Soy un desarrollador junior especializado en desarrollo de aplicaciones multiplataforma. Me apasiona la programación, las nuevas tecnologías y actualmente estoy **formándome en Inteligencia Artificial y Machine Learning**. También trabajo con **WordPress y Elementor** para crear sitios web modernos y funcionales.
